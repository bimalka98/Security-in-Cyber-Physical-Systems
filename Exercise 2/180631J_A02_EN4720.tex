	...
	\begin{enumerate}
		...
		\begin{answer}
			...
			\begin{itemize}
				...
				\item In terms of the similarity there is a drastic change between the tow hash digests (the avalanche effect), even though we made only a simple change to the input file.
			\end{itemize}
